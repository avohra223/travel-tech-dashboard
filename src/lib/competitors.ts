...
export const competitors: TrackedCompetitor[] = [
  {
    ...
    keywords: ["google", "gemini", "google flights", "google travel", "google maps", "ai mode", "google search"],
  ...
  },
  {
    ...
    keywords: ["openai", "chatgpt", "gpt", "sam altman", "operator"],
  ...
  },
  {
    ...
    keywords: ["apple", "siri", "apple intelligence", "apple maps", "apple pay"],
  ...
  },
  {
    ...
    category: "Big Tech",
    threatLevel: "Moderate",
    keywords: ["amazon", "alexa", "amazon travel", "prime travel"],
    valueChainTarget: ["Discovery", "Booking"],
    color: "#FF9900",
  ...
  },
  {
    ...
    category: "Big Tech",
    threatLevel: "Low",
    keywords: ["meta", "facebook", "instagram", "whatsapp travel", "meta ai"],
  ...
  },
  {
    ...
    threatLevel: "High",
    keywords: ["sabre", "sabre corporation"],
