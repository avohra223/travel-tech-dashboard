...
export const competitors: TrackedCompetitor[] = [
  {
    ...
    keywords: ["google", "gemini travel", "google flights", "google travel", "google maps", "google ai mode", "google search"],
  ...
  },
  {
    ...
    keywords: ["openai", "chatgpt", "sam altman"],
  ...
  },
  {
    ...
    keywords: ["apple travel", "apple maps", "apple pay", "siri", "apple intelligence"],
  ...
  },
  {
    ...
    category: "Big Tech",
    threatLevel: "Moderate",
    keywords: ["amazon travel", "alexa", "prime travel", "amazon flights"],
    valueChainTarget: ["Discovery", "Booking"],
    color: "#FF9900",
  ...
  },
  {
    ...
    category: "Big Tech",
    threatLevel: "Low",
    keywords: ["meta ai", "facebook travel", "instagram travel", "whatsapp travel"],
